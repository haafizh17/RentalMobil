...
<head>
    ...
    <title>Daftar Kendaraan Admin - Fizh Rental</title>
    <style>
        body {
...
<body>
    <header>
        ...
        <p>Kelola Rental Kendaraan Anda</p>
    </header>
    <nav>
    ...
    <div class="container">
        ...
        <a href="tambahkendaraan.php" class="add-button">Tambah Kendaraan</a> <!-- Tombol Tambah Kendaraan -->
        <table>
            <thead>
                <tr>
                    <th>Gambar</th>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<td><img src='uploads/" . $row['gambar'] . "' alt='FotoKendaraan' style='width:100px;'></td>";
                        echo "<td>" . $row['jenis'] . "</td>";
                        echo "<td>" . $row['seri'] . "</td>";
                        echo "<td>" . number_format($row['harga'], 0, ',', '.') . "</td>";
                        echo "<td>" . $row['durasisewa'] . " hari</td>";
                        echo "<td>" . $row['deskripsi'] . "</td>";
                        echo "<td>
                                <a href='editkendaraan.php?id=" . $row['id'] . "' class='action-button'>Edit</a>
 <a href='hapuskendaraan.php?id=" . $row['id'] . "' class='action-button'>Hapus</a>
                              </td>"; // Tambahkan tombol Edit dan Hapus
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='7'>Tidak ada data kendaraan.</td></tr>"; // Sesuaikan colspan
                }
                ?>
            </tbody>
        </table>
